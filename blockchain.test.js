...
describe('Blockchain', () => {
    ...
    describe('isValidChain()', () => {
        ...
        describe('when the chain starts with a genesis block and has multiple blocks', () => {
            beforeEach(() => {
                blockchain.addBlock({ data: 'CapAm' });
                blockchain.addBlock({ data: 'Ironman' });
                blockchain.addBlock({ data: 'Thor' });
            });
            ...
            describe('and the chain contains a block with an invalid block', () => {
                it('returns false', () => {
    ...
    describe('replaceChain()', () => {
        ...
        describe('when the new chain is not longer valid', () => {
            beforeEach(() => {
                newChain.chain[0] = { new: 'chain' };
                blockchain.replaceChain(newChain.chain);
            });
            it('does no replace the chain', () => {
                newChain.chain[0] = { new: 'chain' };
        ...
        describe('when the new chain is longer valid', () => {
            beforeEach(() => {
                newChain.addBlock({ data: 'CapAm' });
                newChain.addBlock({ data: 'Ironman' });
                newChain.addBlock({ data: 'Thor' });
            });
